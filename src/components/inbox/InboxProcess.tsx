...
const steps: Step[] = [
  ...
  },
  {
    ...
    title: "Alterações",
    description:
      "Cada solicitação de ajuste tem prazo de retorno. A partir da terceira rodada, poderá ser cobrado valor adicional de R$ 150,00 por solicitação.",
    ...
    <div className="grid gap-4 md:grid-cols-3">
      ...
      <Card className="md:col-span-3 border-border/70 bg-card/60 p-6 shadow-soft backdrop-blur">
        <p className="text-sm text-muted-foreground">
          <span className="text-foreground">Importante:</span> o prazo de 20 dias úteis é contado a partir do briefing e
