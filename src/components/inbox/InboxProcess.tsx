...
const steps: Step[] = [{
  ...
  description: "Todo o alinhamento é feito online. Após o pagamento, você receberá um formulário para entendermos profundamente sua marca.",
...
export function InboxProcess() {
  return <div className="grid gap-4 md:grid-cols-3">
      {steps.map(step => <Card key={step.number} className="border-border/70 bg-card/60 p-6 shadow-soft backdrop-blur">
